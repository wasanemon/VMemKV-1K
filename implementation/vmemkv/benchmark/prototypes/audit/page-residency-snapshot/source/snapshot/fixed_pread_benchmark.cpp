...
// regression_throughput.cppの実験用コピーのmainに挿入。通常測定には入らない。
  if (argc == 2 && std::string(argv[1]) == "--verify") {
    ...
    std::cout << "verify: PASS (1024 keys, three passes; miss; generation CAS)\n";
    return 0;
  }
